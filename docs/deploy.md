...
> `d36d6a9` from `merge/gas-forecast-into-v2`, deployed 8 September 17:04:06 UTC,
> asset stamp `2026-09-08c`. The owner authorised it explicitly as an interim while
...
> engine to 9.8e-16. Rollback archive of the previous tree (`27ecef0`):
