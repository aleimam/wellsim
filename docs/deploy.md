...
> `27ecef0` from `merge/gas-forecast-into-v2`, deployed 7 September 16:22:29 UTC,
> asset stamp `2026-09-07a`. The owner authorised it explicitly as an interim while
...
> engine to 9.8e-16. Rollback archive of the previous tree (`697dfde`):
