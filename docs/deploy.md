...
> `1a94ce0` from `merge/gas-forecast-into-v2`, deployed 6 September 08:58:55 UTC,
> asset stamp `2026-09-06a`. The owner authorised it explicitly as an interim while
...
> engine to 9.8e-16. Rollback archive of the previous tree (`211a96c`):
