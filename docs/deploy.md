...
> `697dfde` from `merge/gas-forecast-into-v2`, deployed 6 September 13:46:45 UTC,
> asset stamp `2026-09-06g`. The owner authorised it explicitly as an interim while
...
> engine to 9.8e-16. Rollback archive of the previous tree (`81f4d8f`):
