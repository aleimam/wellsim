...
> `518b2c7` from `merge/gas-forecast-into-v2`, deployed 6 September 10:34:08 UTC,
> asset stamp `2026-09-06b`. The owner authorised it explicitly as an interim while
...
> engine to 9.8e-16. Rollback archive of the previous tree (`1a94ce0`):
