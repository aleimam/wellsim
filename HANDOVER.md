...
**Live production revision:** 5 September 2026 — `32e1709` from
`merge/gas-forecast-into-v2`, deployed 6 September 10:57:17 UTC, asset stamp
`2026-09-06c`.
...
engine to 9.8e-16. It replaced `518b2c7` (10:34:08 the same morning); the
rollback archive of that tree is
`/root/wellsim-app-pre-deploy-20260906-105701.tar.gz` — restore with
...
`merge/gas-forecast-into-v2` at `32e1709` (160 commits), pushed to origin and
in sync, and **this exact tip is what production runs** — the site was
redeployed on 6 September at 10:57:17 UTC. It is ahead of both `origin/main` (`de2393c`) and
...
`main` (`de2393c`) and production have DIVERGED by 81 commits — production and
