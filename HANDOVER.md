...
**Live production revision:** 5 September 2026 — `697dfde` from
`merge/gas-forecast-into-v2`, deployed 6 September 13:46:45 UTC, asset stamp
`2026-09-06g`.
...
engine to 9.8e-16. It replaced `81f4d8f` (13:18:48 the same day); the
rollback archive of that tree is
`/root/wellsim-app-pre-deploy-20260906-134638.tar.gz` — restore with
...
`merge/gas-forecast-into-v2` at `697dfde` (164 commits), pushed to origin and
in sync, and **this exact tip is what production runs** — the site was
redeployed on 6 September at 13:46:45 UTC. It is ahead of both `origin/main` (`de2393c`) and
...
`main` (`de2393c`) and production have DIVERGED by 85 commits — production and
