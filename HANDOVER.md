...
**Live production revision:** 5 September 2026 — `81f4d8f` from
`merge/gas-forecast-into-v2`, deployed 6 September 13:18:48 UTC, asset stamp
`2026-09-06e`.
...
engine to 9.8e-16. It replaced `32e1709` (10:57:17 the same day); the
rollback archive of that tree is
`/root/wellsim-app-pre-deploy-20260906-131841.tar.gz` — restore with
...
`merge/gas-forecast-into-v2` at `81f4d8f` (162 commits), pushed to origin and
in sync, and **this exact tip is what production runs** — the site was
redeployed on 6 September at 13:18:48 UTC. It is ahead of both `origin/main` (`de2393c`) and
...
`main` (`de2393c`) and production have DIVERGED by 83 commits — production and
